...
var App, Editor, GithubCompatibleAjaxRequest, GithubRepo, HomePage, ListView;
...
HomePage = (function() {
  ...
  function HomePage(app, args, options) {
    this.self = new Element('div', options);
    Object.extend(this.self, HomePage.prototype);
    this.self.init(app, args);
    return this.self;
  }

  HomePage.prototype.init = function(app, args) {
    var t,
      _this = this;
    this.app = app;
    this.args = args;
  ...
  HomePage.prototype.browse = function() {
    ...
    this.app.navigate_to(GithubRepo, this.github_repo);
  };
...
GithubRepo = (function() {
  ...
  function GithubRepo(app, args, options) {
    this.self = new Element('div', options);
  ...
  GithubRepo.prototype.init = function(app, args) {
    var t,
      _this = this;
    this.app = app;
  ...
  GithubRepo.prototype.show_path = function() {
    ...
    path = '<a href="' + this.user_url + '">' + this.user + '</a>';
  ...
  GithubRepo.prototype.fetch_blob = function(cb) {
    ...
    console.log(['foo', this.path, path, this.filename]);
  ...
  GithubRepo.prototype.browse = function(e) {
    var row, url;
    row = e.findElement('.row');
    url = row.url;
    console.log(['browsing to', url]);
    this.app.navigate_to(GithubRepo, url);
  };
...
App = (function() {
  ...
  App.prototype.init = function() {
    var args, path, t, _ref,
      _this = this;
    t = "<div style=\"margin: 0px;\">\n    <div id=\"menu\">\n        <a href=\"#\" id=\"home\">OpenSCAD-Editor</a>\n        <a href=\"#about\" id=\"about\">about</a>\n    </div>\n    <div id=\"content\">\n        \n    </div>\n</div>";
    this.insert(new Template(t).evaluate({}));
    this.select('#home')[0].observe('click', function(e) {
      return _this.navigate_to(HomePage);
    });
    this.select('#about')[0].observe('click', function(e) {
      return _this.navigate_to(AboutPage);
    });
